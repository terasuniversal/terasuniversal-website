...
export default async function DashboardPage() {
  ...
  const [
    ...
    supabase.from("schedules").select("id, start_date, status, capacity, seats_available, courses(title)").gte("start_date", today).is("deleted_at", null).order("start_date", { ascending: true }).limit(6),
