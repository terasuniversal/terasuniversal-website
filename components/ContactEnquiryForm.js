  ...
  return (
    <form className="contact-page-form" onSubmit={handleSubmit}>
      ...
      <div className="contact-page-form-grid">
        <label>Name <span aria-hidden="true">*</span><input name="name" type="text" autoComplete="name" required /></label>
        ...
        <label>Phone <span aria-hidden="true">*</span><input name="phone" type="tel" autoComplete="tel" required /></label>
      </div>
      ...
      <label>Message <span aria-hidden="true">*</span><textarea name="message" rows="6" required /></label>
