...
export default function ScaffoldingServicePage() {
  return (
    <main className="scaffolding-page">
      ...
      <section className="scaffolding-poster-section" aria-labelledby="scaffolding-poster-title"><div className="container scaffolding-poster-grid"><figure className="scaffolding-poster-media"><Image src="/images/scaffolding-rental-poster.webp" alt="TERAS UNIVERSAL Scaffolding Rental and Installation Services" width={853} height={1280} sizes="(max-width: 920px) 260px, 340px" /></figure><div className="scaffolding-poster-copy"><span className="eyebrow">TERAS UNIVERSAL Scaffolding</span><h2 id="scaffolding-poster-title">Scaffolding Solutions You Can Rely On</h2><p>Safe, reliable and professionally managed scaffolding solutions for construction, maintenance and industrial projects. Reach out to discuss your rental duration, scaffolding type and site requirements.</p><div className="hero-actions"><a className="btn btn-gold" href={whatsappHref} target="_blank" rel="noreferrer">Enquire About Scaffolding</a><a className="btn btn-light" href="/request-proposal">Request a Quotation</a></div><p className="scaffolding-poster-phone">Call or WhatsApp: <a href="tel:+60195193834">019-519 3834</a></p></div></div></section>

      <section className="course-final-cta"><div className="container"><div><span className="eyebrow">Scaffolding Enquiries</span><h2>Need Scaffolding for Your Next Project?</h2><p>Talk to TERAS UNIVERSAL about your project requirements, rental duration and site needs.</p></div><div className="hero-actions"><a className="btn btn-gold" href={whatsappHref} target="_blank" rel="noreferrer">WhatsApp 019-519 3834</a><a className="btn btn-light" href="/request-proposal">Request a Quotation</a></div></div></section>
