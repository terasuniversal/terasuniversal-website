    ...
    <main className="services-page">
      ...
      <section className="services-hero" aria-labelledby="services-hero-title">
        <div className="container services-hero-grid">
          ...
          <figure className="services-hero-media"><Image src="/images/temp-ai-corporate-scene-08.webp" alt="Industrial site inspection and safety consultancy visual." width={1200} height={800} priority sizes="(max-width: 920px) 100vw, 52vw" /></figure>
        </div>
      </section>
      ...
      <section className="service-detail-section"><div className="container">{serviceDetails.map(([id, title, text, tags, image], index) => <article id={id} className={`service-detail ${index % 2 ? "service-detail-reverse" : ""}`} key={id}><div className="service-detail-copy"><span className="eyebrow">0{index + 1} &middot; {title}</span><h2>{title}</h2><p>{text}</p><ul>{tags.map((tag) => <li key={tag}>{tag}</li>)}</ul><div className="service-detail-outcome"><small>BUSINESS OUTCOME</small><strong>{serviceOutcomes[id]}</strong></div><a className="btn btn-primary" href="/#contact">Discuss This Service</a></div><figure className="service-detail-media"><Image src={image} alt={`${title} industrial training and consultancy visual.`} width={1100} height={760} sizes="(max-width: 920px) 100vw, 50vw" /></figure></article>)}<article id="scaffolding" className="service-detail service-detail-reverse"><div className="service-detail-copy"><span className="eyebrow">05 &middot; Scaffolding Rental &amp; Installation</span><h2>Scaffolding Rental &amp; Installation</h2><p>Safe, reliable and professionally managed scaffolding solutions for construction, maintenance and industrial projects.</p><ul><li>Scaffolding Rental</li><li>Scaffolding Erection</li><li>Scaffolding Dismantling</li><li>Inspection &amp; Maintenance</li></ul><div className="service-detail-outcome"><small>BUSINESS OUTCOME</small><strong>Safer, well-managed scaffolding for every project stage</strong></div><a className="btn btn-primary" href="/services/scaffolding">View Scaffolding Services</a></div><figure className="service-detail-media scaffolding-teaser-media"><Image src="/images/scaffolding-rental-poster-en.webp" alt="TERAS UNIVERSAL Scaffolding Rental and Installation Services" width={853} height={1280} sizes="(max-width: 920px) 260px, 340px" /></figure></article></div></section>
