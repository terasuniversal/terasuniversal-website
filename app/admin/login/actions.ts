...
import { z } from "zod";
import { writeLoginAudit } from "../../../lib/auth/loginAudit";
...
export async function loginAction(
  ...
  if (user) {
    ...
    // 20260815120000_security_remediation_pack1.sql). The service-role audit
    // is informational only and must not block an otherwise-successful login.
