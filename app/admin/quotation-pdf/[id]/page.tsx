...
export default async function QuotationPdfPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <div className="quotation-print-root">
    <style>{`
      ...
      .quotation-print-header{display:flex;justify-content:space-between;gap:28px;padding-bottom:16px;border-bottom:3px solid ${NAVY}}
      .quotation-print-logo{width:188px;height:auto;object-fit:contain;object-position:left center}
      .quotation-print-company{margin-top:6px;color:${NAVY};font-size:18px;font-weight:800;letter-spacing:.2px}
      ...
      .quotation-print-card-grid{display:grid;grid-template-columns:1fr 1fr;gap:8px}.quotation-print-card{min-height:64px;padding:10px 12px;box-sizing:border-box;border:1px solid #E3E9F0;border-radius:2px}
      ...
      @page{size:A4 portrait;margin:0}@media print{.quotation-print-running-footer{display:block;position:fixed;bottom:4mm;left:12mm;right:12mm;padding-top:2mm;border-top:1px solid ${BORDER};color:${MUTED};font-size:8px;text-align:right}.quotation-print-page-number::after{content:counter(page) " of " counter(pages)}.quotation-print-root{width:210mm;min-height:0;padding:0;background:#fff;font-size:10px}.quotation-print-paper{zoom:1;width:210mm;min-height:0;margin:0;padding:10mm 12mm 28mm;box-shadow:none}.quotation-print-logo{width:118px;height:auto}.quotation-print-company{font-size:16px}.quotation-print-section{margin-top:11px;padding-top:6px}.quotation-print-section:has(.quotation-print-terms){padding:0;border-top:0}.quotation-print-card{min-height:0;padding:7px 9px}.quotation-print-section-title{margin-bottom:6px}.quotation-print-items-section{break-inside:auto;page-break-inside:auto}.quotation-print-items-section .quotation-print-section-title{break-after:avoid;page-break-after:avoid}.quotation-print-items th{padding:5px 5px}.quotation-print-items td{padding:6px 5px;font-size:11px}.quotation-print-package{margin-top:5px}.quotation-print-totals-wrap{margin-top:8px}.quotation-print-totals td{padding:3px 6px}.quotation-print-grand td{padding-top:6px}.quotation-print-footer{margin-top:10px;padding-top:7px;padding-bottom:0}.quotation-print-items thead{display:table-header-group}.quotation-print-header,.quotation-print-card,.quotation-print-totals-wrap{break-inside:avoid;page-break-inside:avoid}*{-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important}}
    ...
    <main className="quotation-print-paper">
      ...
      {training?.inclusions.training_notes && <section className="quotation-print-section"><h2 className="quotation-print-section-title">Training Notes</h2><div className="quotation-print-terms">Training notes are included as part of the quotation snapshot.</div></section>}
      ...
      <div className="quotation-print-running-footer">TERAS UNIVERSAL SDN. BHD. · {q.quotation_no} · {customer.company || "Quotation"} · Page <span className="quotation-print-page-number" /></div>
