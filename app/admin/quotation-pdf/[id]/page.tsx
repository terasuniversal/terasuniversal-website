...
export default async function QuotationPdfPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <div className="quotation-print-root">
    <style>{`
      ...
      @page{size:A4 portrait;margin:0}@media print{.quotation-print-root{width:210mm;min-height:0;padding:0;background:#fff;font-size:10px}.quotation-print-paper{zoom:.7;width:142.857%;min-height:0;margin:0;padding:10mm 12mm 8mm;box-shadow:none}.quotation-print-logo{width:135px}.quotation-print-company{font-size:15px}.quotation-print-title{font-size:21px}.quotation-print-section{margin-top:12px}.quotation-print-section:has(.quotation-print-terms){padding:0}.quotation-print-card{min-height:0;padding:7px 9px}.quotation-print-section-title{margin-bottom:6px}.quotation-print-items-section{break-inside:avoid;page-break-inside:avoid}.quotation-print-items-section .quotation-print-section-title{break-after:avoid;page-break-after:avoid}.quotation-print-items th{padding:5px 5px}.quotation-print-items td{padding:6px 5px}.quotation-print-package{margin-top:5px}.quotation-print-totals-wrap{margin-top:10px}.quotation-print-totals td{padding:3px 0}.quotation-print-grand td{padding-top:6px}.quotation-print-footer{margin-top:12px;padding-top:8px;padding-bottom:0}.quotation-print-items thead{display:table-header-group}.quotation-print-header,.quotation-print-card,.quotation-print-totals-wrap{break-inside:avoid;page-break-inside:avoid}*{-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important}}
