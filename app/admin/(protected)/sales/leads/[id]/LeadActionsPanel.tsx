        ...
        canManage && (
          <Card title="Convert to Opportunity">
            <form action={convertAction} className="ta-card-pad ta-stack">
              ...
              <div className="ta-alert ta-alert-info" role="status">
                Convert this lead only after it is qualified. This creates one Opportunity linked to the lead; it does not create a standalone opportunity.
              </div>
              ...
              <button type="submit" className="ta-btn ta-btn-primary ta-btn-sm" disabled={convertPending}>
                {convertPending ? "Converting…" : "🎯 Convert qualified lead to Opportunity"}
              </button>
            </form>
          </Card>
        )
