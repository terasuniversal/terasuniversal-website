...
export async function GET(request: NextRequest) {
  ...
  const opportunitiesQuery = supabase.from("sales_opportunities").select("id, created_at, stage, lead_metadata_id").gte("created_at", range.startUtc).lt("created_at", range.endUtc);
