...
export function TrainerForm({
  ...
  return (
    <form action={formAction} className="ta-form" style={{ maxWidth: 860 }}>
      ...
      <h3 style={{ fontSize: 15, margin: "12px 0 4px" }}>Employment Details</h3>
      <div className="ta-field-row">
      ...
      <h3 style={{ fontSize: 15, margin: "12px 0 4px" }}>Competencies & Qualifications</h3>
      ...
      <h3 style={{ fontSize: 15, margin: "12px 0 4px" }}>Photo & Signature</h3>
      <div className="ta-field-row">
