...
- **Courses** — full create / edit / preview / soft-delete.
- **Training Schedule** — full CRUD + duplicate + cancel.
- **Participants** — full CRUD + register to a schedule.
- **Certificates** — issue / revoke / reinstate, auto verification code + QR.
...
Remaining as scaffold (data layer done, copy the Courses pattern): News,
Gallery, FAQ, Downloads, Company Profile, Media Library, Users & Roles.
